...
<?php }
  ...
  <div class="main_parent<?php echo $Total_Soft_Gallery_Video; ?>" style="position: relative; width: 100%; float: left;">
    ...
    <div class="main TotalSoft_GV_CP_Main TotalSoft_GV_CP_Main<?php echo $Total_Soft_Gallery_Video; ?>">
      <script type="text/javascript">
        <!--
           function ts_data_id (id){
                 let data = jQuery.parseJSON('<?php echo json_encode($Total_Soft_GalleryV_Videos) ?>');
                  let res = [];
                  let r = 0;
  ...
  <script type="text/javascript">
    ...
    function TotalSoft_GV_CP_Cont<?php echo $Total_Soft_Gallery_Video;?>(TotalSoftGV_CP_VID, TotalSoftGV_CP_ID) {
      var b=Array();
      b = ts_data_id (TotalSoftGV_CP_VID);
      b[4] = b[4].replace('Tsyou_','https://www.youtube.com/embed/');
      b[5] = b[5].replace('Tsyou_','https://img.youtube.com/vi/');
      b[6] = b[6].replace('Tsyou_','https://www.youtube.com/watch?v=');
      ...
      jQuery('html').css({'cursor': 'default'});
          ...
          jQuery('.TotalSoft_GV_CP_TD<?php echo $Total_Soft_Gallery_Video;?> h2').html(decodeEntities(b[0]));
          jQuery('.TotalSoft_GV_CP_TD<?php echo $Total_Soft_Gallery_Video;?> p').html(decodeEntities(b[1]));

          if(TotalSoft_GV_CP_PoM=='') {
            jQuery('.TotalSoft_GV_CP_Content<?php echo $Total_Soft_Gallery_Video;?>').animate({'height': '100%',}, 300).css({'max-width': '100vw'});
      ...
      jQuery.ajax({
        type: 'POST', url: object.ajaxurl, data: {
          ...
          b[b.length - 1]=b[b.length - 1].split(')')[0].trim();
           b[5] = b[5].replace('Tsyou_','https://www.youtube.com/embed/');
           b[6] = b[6].replace('Tsyou_','https://img.youtube.com/vi/');
           b[7] = b[7].replace('Tsyou_','https://www.youtube.com/watch?v=');
