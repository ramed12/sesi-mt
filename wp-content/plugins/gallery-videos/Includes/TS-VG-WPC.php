    ...
    function TotalSoft_GV_SG_OPop<?php echo $Total_Soft_Gallery_Video;?>(SG_ID, SG_V_NUM) {
      ...
      setTimeout(function() {
        ...
        if(TotalSoftGallery_Video_ShowType<?php echo $Total_Soft_Gallery_Video;?> =="All") {
          iframesource<?php echo $Total_Soft_Gallery_Video;?> =jQuery('.TotalSoft_GV_SG_Item_' + SG_ID + '_' + SG_V_NUM + ' iframe').attr('data-tsvg');
          if(!iframesource<?php echo $Total_Soft_Gallery_Video;?>) {
            iframesource<?php echo $Total_Soft_Gallery_Video;?> =jQuery('.TotalSoft_GV_SG_Item_' + SG_ID + '_' + SG_V_NUM + ' video source').attr('data-tsvg');
          }
          if(!iframesource<?php echo $Total_Soft_Gallery_Video;?>) {
            imagesource<?php echo $Total_Soft_Gallery_Video;?> =jQuery('.TotalSoft_GV_SG_Item_' + SG_ID + '_' + SG_V_NUM + ' img').attr('data-tsvg');
          }
        }
        else {
          iframesource<?php echo $Total_Soft_Gallery_Video;?> =jQuery('.TotalSoft_GV_SG_Item_' + SG_ID + '_' + (SG_V_NUM + 1) + ' iframe').attr('data-tsvg');
          if(!iframesource<?php echo $Total_Soft_Gallery_Video;?>) {
            iframesource<?php echo $Total_Soft_Gallery_Video;?> =jQuery('.TotalSoft_GV_SG_Item_' + SG_ID + '_' + (SG_V_NUM + 1) + ' video source').attr('data-tsvg');
          }
          if(!iframesource<?php echo $Total_Soft_Gallery_Video;?>) {
            imagesource<?php echo $Total_Soft_Gallery_Video;?> =jQuery('.TotalSoft_GV_SG_Item_' + SG_ID + '_' + SG_V_NUM + ' img').attr('data-tsvg');
          }
    ...
    <div class="TotalSoft_GV_SG_Grid_<?php echo $Total_Soft_Gallery_Video; ?>">
         ...
         <div class="TotalSoft_GV_SG_Item_<?php echo $Total_Soft_Gallery_Video; ?> TotalSoft_GV_SG_Item_<?php echo $Total_Soft_Gallery_Video; ?>_<?php echo $i; ?>">
            ...
            <div class="TotalSoft_GV_SG_Imagediv_<?php echo $Total_Soft_Gallery_Video; ?>">
              <img data-tsvg="<?php echo str_replace('Tsyou_','https://img.youtube.com/vi/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL); ?>" src="<?php echo  str_replace('Tsyou_','https://img.youtube.com/vi/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL); ?>">
            </div>
										<?php }else{ ?>
            <div class="TotalSoft_GV_SG_Videodiv_<?php echo $Total_Soft_Gallery_Video; ?>">
               ...
               <video controls poster="<?php echo  str_replace('Tsyou_','https://img.youtube.com/vi/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL); ?>">
                 <source  data-tsvg="<?php echo str_replace('Tsyou_','https://img.youtube.com/vi/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL); ?> "  src="<?php echo str_replace('Tsyou_','https://www.youtube.com/embed/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL); ?>" type="video/mp4">
               </video>
													<?php }else{ ?>
                 ...
                 <iframe data-tsvg="<?php echo str_replace('Tsyou_','https://img.youtube.com/vi/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL); ?>&autoplay=0&controls=1&showinfo=0&autohide=1&rel=0&iv_load_policy=3 " src="<?php echo str_replace('Tsyou_','https://www.youtube.com/embed/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL); ?>&autoplay=0&controls=1&showinfo=0&autohide=1&rel=0&iv_load_policy=3" frameborder="0" webkitAllowFullScreen></iframe>
														<?php }else{ ?>
                 <iframe  data-tsvg="<?php echo str_replace('Tsyou_','https://img.youtube.com/vi/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL); ?>?autoplay=0&controls=1&showinfo=0&autohide=1&rel=0&iv_load_policy=3 "  src="<?php echo str_replace('Tsyou_','https://www.youtube.com/embed/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL); ?>?autoplay=0&controls=1&showinfo=0&autohide=1&rel=0&iv_load_policy=3" frameborder="0" webkitAllowFullScreen></iframe> <?php } ?>
													<?php } ?>
            </div>
										<?php } ?>
           ...
           <div class="TotalSoft_GV_SG_Item_<?php echo $Total_Soft_Gallery_Video; ?> TotalSoft_GV_SG_Item_<?php echo $Total_Soft_Gallery_Video; ?>_<?php echo $i + 1; ?> noshow1" style="display: none;">
										<span class="TotalSoft_GV_SG_VideoTitle_<?php echo $Total_Soft_Gallery_Video; ?>">
											<?php echo html_entity_decode($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT); ?>
												...
												<?php if(str_replace('Tsyou_','https://www.youtube.com/embed/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL)==''){ ?>
              <div class="TotalSoft_GV_SG_Imagediv_<?php echo $Total_Soft_Gallery_Video; ?>">
                <img src="<?php echo str_replace('Tsyou_','https://img.youtube.com/vi/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL); ?>" data-tsvg="<?php echo str_replace('Tsyou_','https://img.youtube.com/vi/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL); ?>">
              </div>
												<?php }else{ ?>
              <div class="TotalSoft_GV_SG_Videodiv_<?php echo $Total_Soft_Gallery_Video; ?>">
															<?php if(strpos(str_replace('Tsyou_','https://www.youtube.com/embed/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL),'.mp4')>0){ ?>
