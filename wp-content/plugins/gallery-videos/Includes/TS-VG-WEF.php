    ...
    <div id="video-gallery" class='Tot_Vid_Gallery<?php echo $Total_Soft_Gallery_Video; ?>' style='text-align:center; display: -webkit-inline-box;margin: 0 auto;'>
					<?php for($i=0;$i<count($Total_Soft_GalleryV_Videos);$i ++){ ?>
						<?php if(str_replace('Tsyou_','https://www.youtube.com/embed/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL)==''){
							$TS_GV_EG_VSR=str_replace('Tsyou_','https://img.youtube.com/vi/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL);
							$TS_GV_EG_PSR='';
						}
						else{
							$TS_GV_EG_VSR  =str_replace('Tsyou_','https://www.youtube.com/watch?v=',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_Video);
							$TS_GV_EG_PSR  =str_replace('Tsyou_','https://img.youtube.com/vi/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL);
							$TS_GV_EG_PSRST=str_replace('Tsyou_','https://www.youtube.com/embed/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL);
						} ?>
         ...
         <div id="TotalSoft_GV_HLG_<?php echo $Total_Soft_Gallery_Video; ?>_<?php echo $i + 1; ?>" class='fhovZoom<?php echo $Total_Soft_Gallery_Video; ?>' href="<?php echo $TS_GV_EG_PSRST; ?>" data-poster="<?php echo $TS_GV_EG_PSR; ?>" onclick='TotalsofthPIcon()'>
           <a href='#'> <img class='zEff <?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_08; ?>' style='max-width:none;' src="<?php echo str_replace('Tsyou_','https://img.youtube.com/vi/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL); ?>"/>
      ...
      Video.prototype.loadVideo=function(src, addClass, noposter, index, html) {
        ...
        if(isVideo.youtube) {
          if(isVideo.youtube.input.indexOf('start')=== -1) {
            ...
            video='<iframe class="lg-video-object lg-youtube ' + addClass + '" width="560" height="315" src="//www.youtube.com/embed/' + isVideo.youtube[1] + a + '" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"  allowfullscreen></iframe>';
          }
          else {
            a='&autoplay=1&mute=0&enablejsapi=1';
            if(this.core.s.youtubePlayerParams) {
            ...
            video='<iframe class="lg-video-object lg-youtube ' + addClass + '" width="560" height="315" src="' + isVideo.youtube.input + a + '" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"  allowfullscreen></iframe>';
          }
        }
          ...
          video='<iframe class="lg-video-object lg-vimeo ' + addClass + '" width="560" height="315"  src="' + src + '" frameborder="0" webkitAllowFullScreen mozallowfullscreen allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"  allowFullScreen></iframe>';
        }
          ...
          video='<iframe class="lg-video-object lg-dailymotion ' + addClass + '" width="560" height="315" src="//www.dailymotion.com/embed/video/' + isVideo.dailymotion[1] + a + '" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"  allowfullscreen></iframe>';
        }
          ...
          video='<iframe class="lg-video-object lg-youtube ' + addClass + '" width="560" height="315" src="' + isVideo.wistia + '" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"  allowfullscreen></iframe>';
        }
        else if(isVideo.mp4) {
          video='<iframe class="lg-video-object lg-html5 ' + addClass + '" width="560" height="315" src="' + isVideo.mp4 + '" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"  allowfullscreen></iframe>';
        }
        return video;
      };
...
<?php }
  ...
  <div class="da-thumbs-parent<?php echo $Total_Soft_Gallery_Video; ?>" style="position: relative; width: 100%; float: left;">
    ...
    <ul id="da-thumbs" class="da-thumbs Total_Soft_GV_Fancy_<?php echo $Total_Soft_Gallery_Video; ?>" style='padding:0px;'>
					<?php for($i=0;$i<count($Total_Soft_GalleryV_Videos);$i ++){ ?>
						<?php if(str_replace('Tsyou_','https://www.youtube.com/embed/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL)==''){
							$TS_GV_FG_VSR=str_replace('Tsyou_','https://img.youtube.com/vi/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL);
						}
						else{
							$TS_GV_FG_VSR=str_replace('Tsyou_','https://www.youtube.com/embed/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VURL);
						} ?>
						<?php if($Total_Soft_GalleryV_Man[0]->TotalSoftGallery_Video_ShowType=='All'){ ?>
         ...
         <a href="<?php echo $TS_GV_FG_VSR; ?>" class="html5lightbox" data-width="<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_33; ?>" data-height="<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_34; ?>" data-group="mygroup<?php echo $Total_Soft_GalleryV_Man[0]->id; ?>" data-thumbnail="<?php echo str_replace('Tsyou_','https://img.youtube.com/vi/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL); ?>" title="<?php echo $Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VT; ?>"
										<?php
										$noconvert=htmlentities($Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_VDesc);
										$convert  =do_shortcode(html_entity_decode($noconvert));
										?>
          data-description='<?php echo $convert; ?>'> <img style='margin:0px;max-width:none;width:<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_01; ?>px;height:<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_02; ?>px;' src="<?php echo str_replace('Tsyou_','https://img.youtube.com/vi/',$Total_Soft_GalleryV_Videos[$i]->TotalSoftGallery_Video_IURL); ?>">
  ...
  <input type='text' style='display:none;' class='Totalsoft_FG_PThumb_HBC' value='<?php echo $TotalSoftGallery_Video_Opt1[0]->TotalSoft_GV_1_35; ?>'>
     <input type='text' style='display:none;' class='TS_VG_FG_Show_Nav' value='<?php echo $TotalSoftGallery_Video_Opt2[0]->TotalSoft_GV_2_10; ?>'>
