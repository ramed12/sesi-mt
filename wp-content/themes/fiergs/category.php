 ...
 <div class="container">
    ...
    <div class="row">
        <div class="col-md-8 col-xxl-7 col-12">
            <h3 class="px-3 py-3 tag-section"><i class="fas fa-book-open"></i> <?php echo $cat[0]->name; ?></h3> 
               ...
               if ( ! empty( $categories ) ) {
                ...
                <div class="item">
                    ...
                    <div class="px-5 py-4">
                        <div class="row">
                            <div class="tag-category w-50 py-4"><a href="<?php echo esc_url( get_term_link($categories[0]->term_id)); ?>"><?php echo $category; ?></a></div> <div class="tag-post-date w-50 py-4"><?php echo $post_date; ?></div>
            ...
            <h3 class="py-3 tag-section"><i class="far fa-bell"></i> Mais Conteúdos</h3> 
            ...
            <div class="text-end"><a href="javascript:void(0)" data-category="<?php echo $cat[0]->term_id; ?>" data-admin-url="<?php echo admin_url('admin-ajax.php'); ?>" id="more_posts" class="btn btn-orange rounded-0 px-4 py-2"><i class="fas fa-ellipsis-h fa-2x"></i></a></div>
            <?php endif; ?>
        </div>
        <div class="col-md-3 col-xxl-4 offset-1 col-12">
            ...
            <?php if ( have_posts() ) { ?> 
                ...
                <?php $my_query = new WP_Query( 'posts_per_page=4&cat='.$cat[0]->term_id  ); ?> 
                <?php while ( $my_query->have_posts() ) { 
                    $my_query->the_post();   
