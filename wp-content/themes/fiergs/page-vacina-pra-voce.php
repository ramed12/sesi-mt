<?php
/*
Template Name: Página Vacina Para voce
*/
...
?> 
    ...
    <div class="container" >
        <div class="col-12" style="background-color: #FFF;border-radius: 30px;">
            <div class="row">
                <div class="py-4 text-center vacina-title">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <ul class="vacina-menu">
                                    <li class="active"><a href="#">Para você</a></li>
                                    <li><a href="#">Para Empresa</a></li>
                                </ul>
                            </div>
                            <div class="col-12 pb-4">
                                <ul class="vacina-tipo">
                                    <?php
                                    ...
                                    ?>
                                        <div class="vacina">
                                            ...
                                            <?php while($data->have_posts()){ 
                                                $data->the_post();    
                                            ?>
                                            <div class="text-white vacina-card">
                                                <div class="vacina-card-title"><?php echo the_title(); ?></div>
                                                    <div class="vacina-card-content"><?php echo the_excerpt(); ?>
                                                    <p class="text-center pt-4">
                                                    <a href="#" class="vacina-card-btn-more btn-more-vacina" data-bs-toggle="modal" data-bs-target="#vacinaModal" data-excerpt="<?php echo the_excerpt(); ?>" data-title="<?php echo the_title(); ?>" data-content="<?php echo the_content(); ?>">leia mais</a>
                                                    </p>
                                                    </div>
                                            </div> 
                                            <?php } 
            ...
            <div class="container mt-5 text-white"> 
                    <div class="col-12 p-5" style="background-color: #3E8CA8;border-radius: 30px;">
                        <div class="row">
                        <?php
                            $args3 = array(
            ...
            <div class="container py-5">
                <div class="row">
                    <div class="col-12 text-white vacina-title text-center py-3">Vacinas são importantes, seguras e eficazes!</div>
                        <div class="col-12 py-5">
                            <div class="row">
                                <div class="col-md-1 col-lg-1 col-xl-1 col-xxl-1 col-2 py-4"><img src="<?php echo get_site_url(); ?>/wp-content/themes/fiergs/assets/images/icon_vacina.png" class="img-fluid"></div>
                                <div class="col-md-5 col-lg-5 col-xl-5 col-xxl-5 col-4 py-4 text-white vacina-content">A vacinação vem reduzindo significativamente a incidência de doenças  responsáveis pela morte de milhares de pessoas, todo ano.</div>
                                <div class="col-md-1 col-lg-1 col-xl-1 col-xxl-1 col-2 py-4"><img src="<?php echo get_site_url(); ?>/wp-content/themes/fiergs/assets/images/icon_vacina.png" class="img-fluid"></div>
                                <div class="col-md-5 col-lg-5 col-xl-5 col-xxl-5 col-4 py-4 text-white vacina-content">Segundo a Organização Mundial da Saúde (OMS), anualmente a vacinação evita de dois a três milhões de mortes.</div>
                                <div class="col-md-1 col-lg-1 col-xl-1 col-xxl-1 col-2 py-4"><img src="<?php echo get_site_url(); ?>/wp-content/themes/fiergs/assets/images/icon_vacina.png" class="img-fluid"></div>
                                <div class="col-md-5 col-lg-5 col-xl-5 col-xxl-5 col-4 py-4 text-white vacina-content">Caso as pessoas parem de se vacinar, rapidamente as doenças podem se tornar uma epidemia.</div>
                                <div class="col-md-1 col-lg-1 col-xl-1 col-xxl-1 col-2 py-4"><img src="<?php echo get_site_url(); ?>/wp-content/themes/fiergs/assets/images/icon_vacina.png" class="img-fluid"></div>
                                <div class="col-md-5 col-lg-5 col-xl-5 col-xxl-5 col-4 py-4 text-white vacina-content">A vacinação vai além da proteção individual, é uma responsabilidade social coletiva.</div>
                            </div>
                        </div>
                    </div>
            </div>
            <div class="container py-5">
                <div class="row">
                    <div class="col-12 text-white vacina-title-2">“Muitas doenças comuns no Brasil e no mundo deixaram de ser um problema de saúde pública por causa da vacinação massiva da população.”</div>
                    <div class="col-12 vacina-sit py-3">Ministério da Saúde</div>
                </div>
            </div>
    ...
    <div class="col-12" style="background-color: #FFF;padding-bottom:100px">
        <div class="container py-5">
            <div class="row">
                <div class="col-12 text-center vacina-title">Vacinação do SESI na mídia</div>
                <div class="col-12 vacina-content py-5">
                Com as recentes transformações do mundo, mais do que nunca, acreditamos na eficácia da vacinação como prevenção e agente da saúde pública. Ao estar em dia com a sua vacinação, você ajuda toda a comunidade a reduzir os casos de diversas doenças.
                </div>
                <div class="col-12">
